...
if __name__ == '__main__':
    ...
    for filename in os.listdir(path):
        if filename.endswith(".flac") or filename.endswith(".mp3") or filename.endswith(".wav") or filename.endswith(
            ".m4a"):
    ...
    print('end')
    print('ended cycle no {0} in {1} minutes'.format(run_cycle, (time.time() - start_time) / 60))
